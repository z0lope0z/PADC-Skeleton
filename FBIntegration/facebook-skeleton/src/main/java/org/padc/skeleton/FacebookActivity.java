...
import org.padc.skeleton.fb.FBHelper;
import org.padc.skeleton.fb.models.Friend;
            ...
            facebook.authorize(this,
                    ...
                    new DialogListener() {
                        public void onComplete(Bundle values) {
                            ...
                            updateProfilePic();
                            showFriendsList();
                            Log.i("FacebookActivity", "Current user's email : " + fbHelper.getCurrentUserFacebook().getEmail());
                        }
